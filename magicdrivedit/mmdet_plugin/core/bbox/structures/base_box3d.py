...
class BaseInstance3DBoxes:
    ...
    @property
    def tokens(self):
        return [self.raw_tokens[int(i)] for i in self.tensor[:, -1]]
    ...
    def __getitem__(self, item):
        ...
        return original_type(b, box_dim=self.box_dim, with_yaw=self.with_yaw, tokens=self.raw_tokens)
