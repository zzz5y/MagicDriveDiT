...
bucket_config = { 
    # 15-20s/it bs=10 sp=2
    "224-400-120-1": 10,  # 10-12 TODO: should be more, but has unknown bug.
    # 9 base, 33-35s/it bs=8 sp=2, 30s/it bs=10, sp=4
    "224-400-12-9": 8,  # 8-10
    # 17 base, 26-27s/it bs=4 sp=2, 35s/it bs=6 sp=4
    "224-400-12-17": 4,  # 4-6
    # 33 base, 25s/it bs=2 sp=2, 27s/it bs=3 sp=4
    "224-400-12-33": 2,  # 2-3
    # 65 base, 25s/it bs=1 sp=2, 20s/it bs=1 sp=4, stuck bs=2 sp=4
    "224-400-12-65": 1,

    # 35-36s/it bs=10 sp=2, 30s/it bs=12 sp=4
    "424-800-120-1": 10,  # 10-12
    # 9 base, 48s bs=4 sp=4, 34s bs=3 sp=4
    "424-800-12-9": 2,  # 2-3
    # 17 base, 21s bs=1 sp=4, 39s bs=2 sp=4
    "424-800-12-17": 1, 
    # 33 base, 57-60s sp=2, 32-35s sp=4
    "424-800-12-33": 1,
}
# no need to change this!
...
vae = dict(
    ...
    micro_frame_size=16,  # backward-compatible, no need to change others
    micro_batch_size=1,
)
text_encoder = dict(
    type="t5",
