...
frame_interval = 1
save_fps = 120
save_mode = "image_filename"
skip_save_original = True
...
dataset_cfg_overrides = (
    ...
    ("dataset.data.val.ann_file", "./data/nuscenes_mmdet3d-12Hz/nuscenes_interp_12Hz_infos_val_with_bid.pkl"),  # only contains first 17 frames
    ("dataset.data.val.start_on_keyframe", True),
)
...
# Log settings
seed = 42
outputs = "outputs/eval/CogVAE-848-Img"
wandb = False
epochs = 150
log_every = 1
ckpt_every = 500 * 5
